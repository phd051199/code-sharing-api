...
import { NestedEnumAuthProvidersWithAggregatesFilter } from './nested-enum-auth-providers-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAuthProvidersFilter } from './nested-enum-auth-providers-filter.input';

@InputType()
export class EnumAuthProvidersWithAggregatesFilter {

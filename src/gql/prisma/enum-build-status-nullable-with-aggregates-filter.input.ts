...
import { NestedEnumBuildStatusNullableWithAggregatesFilter } from './nested-enum-build-status-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumBuildStatusNullableFilter } from './nested-enum-build-status-nullable-filter.input';

@InputType()
export class EnumBuildStatusNullableWithAggregatesFilter {

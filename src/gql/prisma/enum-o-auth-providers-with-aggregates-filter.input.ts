...
import { NestedEnumOAuthProvidersWithAggregatesFilter } from './nested-enum-o-auth-providers-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumOAuthProvidersFilter } from './nested-enum-o-auth-providers-filter.input';

@InputType()
export class EnumOAuthProvidersWithAggregatesFilter {

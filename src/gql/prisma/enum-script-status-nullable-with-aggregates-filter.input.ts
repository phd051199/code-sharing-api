...
import { NestedEnumScriptStatusNullableWithAggregatesFilter } from './nested-enum-script-status-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumScriptStatusNullableFilter } from './nested-enum-script-status-nullable-filter.input';

@InputType()
export class EnumScriptStatusNullableWithAggregatesFilter {

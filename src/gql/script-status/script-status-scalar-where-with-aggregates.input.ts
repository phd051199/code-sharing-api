...
@InputType()
export class ScriptStatusScalarWhereWithAggregatesInput {

    @Field(() => [ScriptStatusScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<ScriptStatusScalarWhereWithAggregatesInput>;

    @Field(() => [ScriptStatusScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<ScriptStatusScalarWhereWithAggregatesInput>;

    @Field(() => [ScriptStatusScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<ScriptStatusScalarWhereWithAggregatesInput>;

...
import { ScriptUpdateOneRequiredWithoutScript_statusNestedInput } from '../script/script-update-one-required-without-script-status-nested.input';

@InputType()
export class ScriptStatusUpdateInput {
    ...
    @Field(() => ScriptUpdateOneRequiredWithoutScript_statusNestedInput, {nullable:true})
    script?: ScriptUpdateOneRequiredWithoutScript_statusNestedInput;
}
